ITEM.name = "Green Kevlar Uniform"
ITEM.description = "A green top with kevlar, offering decent armor. Often worn by resistance figures."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/clothingitems/torso_rebel_torso_1.mdl"
ITEM.width = 1
ITEM.height = 1
ITEM.iconCam = {
