...
ITEM.description = "A fairly comfortable red Rain jacket. It is helpful at keeping you warm and safe from the water"
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/update_items/redcoat_item.mdl"
ITEM.width = 1
ITEM.height = 1
ITEM.iconCam = {
