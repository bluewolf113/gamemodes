ITEM.name = "Combine Engineering Core Hazard Suit MK5"
ITEM.description = "A hazmat suit worn by the Combine Engineering Core, offering protection against hazardous environments. It features a working AXON 3 bodycam, a safety harness, holsters, and a built-in filtration system. The suit also has a slightly functioning biosignal that can only be read by Chief Engineers."
