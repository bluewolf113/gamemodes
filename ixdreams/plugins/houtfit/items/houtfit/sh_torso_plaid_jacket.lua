ITEM.name = "Plaid Jacket"
ITEM.description = "A black and red checkered jacket. Keeps you warm and hip."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/clothingitems/torso_alyxcoat6.mdl"
ITEM.width = 1
ITEM.height = 1
ITEM.iconCam = {
    pos = Vector(-39.23, -7.19, 195.95),
    ang = Angle(76.37, 10.08, 0),
    fov = 4.05
}
