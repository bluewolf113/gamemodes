ITEM.name = "Black Suit Jacket"
ITEM.description = "A Thick Suit Jacket used by the Elite of the Loyalists. This one is Black."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/update_items/cajacket2_item.mdl"
ITEM.width = 1
ITEM.height = 1
ITEM.iconCam = {
