ITEM.name = "Grey Suit Jacket"
ITEM.description = "A Thick Suit Jacket used by the Elite of the Loyalists. This one is grey."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/update_items/cajacket1_item.mdl"
ITEM.width = 1
ITEM.height = 1
ITEM.iconCam = {
