ITEM.name = "Grey Kevlar Uniform"
ITEM.description = "A grey top with kevlar, offering decent armor. Often worn by resistance figures. It has a Fist insignia in red on the side."
