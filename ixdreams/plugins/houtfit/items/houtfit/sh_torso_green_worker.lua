ITEM.name = "Green Worker's Jacket"
ITEM.description = "A sturdy, heavy knit jacket with Green design."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/update_items/worker04_item.mdl"
ITEM.width = 1
ITEM.height = 1
ITEM.iconCam = {
