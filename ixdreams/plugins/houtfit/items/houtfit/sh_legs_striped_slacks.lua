ITEM.name = "Striped Suit Trousers"
ITEM.description = "A pair of black suit trousers with white lining. They look very high quality."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/clothingitems/legs_ca_5.mdl"
ITEM.width = 1
ITEM.height = 1
ITEM.iconCam = {
    pos = Vector(-1.2, -0.25, 200),
    ang = Angle(90.94, 191.81, 0),
    fov = 6.28
}
