ITEM.name = "Thick Leather Jacket"
ITEM.description = "A sturdy, heavy Jacket made out of leather."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/update_items/jacket01_item.mdl"
ITEM.width = 1
ITEM.height = 1
ITEM.iconCam = {
