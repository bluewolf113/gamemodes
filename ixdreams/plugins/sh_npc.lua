...
PLUGIN.LootTable = {
    [ "drgbase_nosalis" ] = {
        minItems = 1, --Minimum amount of items this NPC will drop.
        maxItems = 3, --Maximum amount of items this NPC will drop.
        name = 'Nosali muerto', --What this NPC's name is whenever someone looks at the corpse.
		description = 'El cadaver de un Nosali que ha muerto recientemente quizas se pueda rescatar algo...', --The text under the name when someone looks at the corpse.
        items = { "carne_bicho", "carne_bicho", "cuero_sucio", "cuero_sucio","carne_bicho", "carne_bicho", "cuero_sucio", "cuero_sucio", "ojo_nosalis", "calavera", "hueso", "circuito", "cochecito" } --The list of items this NPC will drop if it will drop any items.
    },
	[ "drgbase_lurker" ] = {
        minItems = 0, --Minimum amount of items this NPC will drop.
        maxItems = 2, --Maximum amount of items this NPC will drop.
        name = 'Lurker muerto', --What this NPC's name is whenever someone looks at the corpse.
		description = 'El cadaver de un Lurker que ha muerto recientemente quizas se pueda rescatar algo...', --The text under the name when someone looks at the corpse.
        items = { "carne_bicho", "carne_bicho", "cuero_sucio", "cuero_sucio", "calavera", "osito", "hueso", "circuito" } --The list of items this NPC will drop if it will drop any items.
    },
	[ "drgbase_nosalis_female" ] = {
        minItems = 0, --Minimum amount of items this NPC will drop.
        maxItems = 4, --Maximum amount of items this NPC will drop.
        name = 'Nosali Hembra muerto', --What this NPC's name is whenever someone looks at the corpse.
		description = 'El cadaver de un Nosali que ha muerto recientemente quizas se pueda rescatar algo...', --The text under the name when someone looks at the corpse.
        items = { "carne_bicho", "carne_bicho", "cuero_sucio", "cuero_sucio", "osito", "carne_bicho", "carne_bicho", "cuero_sucio", "cuero_sucio", "ojo_nosalis", "calavera", "hueso", "circuito", "cochecito" } --The list of items this NPC will drop if it will drop any items.
    },
	[ "drgbase_scorpion" ] = {
        minItems = 0, --Minimum amount of items this NPC will drop.
        maxItems = 4, --Maximum amount of items this NPC will drop.
        name = 'Nosali muerto', --What this NPC's name is whenever someone looks at the corpse.
		description = 'El cadaver de un Nosali que ha muerto recientemente quizas se pueda rescatar algo...', --The text under the name when someone looks at the corpse.
        items = { "carne_bicho", "carne_bicho", "cuero_sucio", "cuero_sucio","carne_bicho", "carne_bicho", "cuero_sucio", "cuero_sucio", "tornillos", "aguja_escorpion", "calavera", "hilo", "hueso", "circuito", "cochecito" } --The list of items this NPC will drop if it will drop any items.
    } 
}

ix.config.Add("corpseSearchTime", 5, "How long it takes to search a body.", nil, { --Added since we aren't using the persistant_corpses plugin 
	data = {min = 0, max = 10},
...
ix.inventory.Register( "NPCLootStorage", 6, 6 )
...
function PLUGIN:PlayerUse( player, entity )
    ...
    if ( entity.nextUse and entity.nextUse < CurTime( ) ) or not entity.nextUse then
        ...
        ix.storage.Open( player, inventory, {
            entity = entity,
            name = "Corpse",
            searchText = "Removiendo piel/ropa... buscando por cosas utiles...",
