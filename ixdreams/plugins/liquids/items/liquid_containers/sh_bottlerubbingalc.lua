...
ITEM.name = "Bottle of Rubbing Alcohol";
ITEM.model = "models/props_lab/jar01b.mdl";
ITEM.width	= 1;
ITEM.height	= 2;
ITEM.description = "Clearns.";
ITEM.category = "Containers";
ITEM.liquid = "rubbingalc"                               -- default to being empty
ITEM.capacity = 300                             -- max capacity of the container, in mL
