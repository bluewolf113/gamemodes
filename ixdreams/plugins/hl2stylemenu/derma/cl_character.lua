...
function PANEL:Init()
	...
	self:SetSize(parent:GetWide() * 0.1, parent:GetTall())
...
function PANEL:Init()
	...
	logoPanel:SetSize(ScrW() * 0.25, ScrH() * 0.15)
	logoPanel:SetPos(self:GetPadding(), self:GetTall() - (self.loadButton:GetTall() * 4) - logoPanel:GetTall() - self:GetPadding())
	logoPanel:SetZPos(self.mainButtonList:GetZPos() - 1)
	...
	if (logo and !logo:IsError()) then
		...
		logoImage:SetSize(halfWidth * 0.75, (halfWidth * logo:Height() / logo:Width()) * 0.75)
