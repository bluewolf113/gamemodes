...
function PANEL:AddTab(id, filter)
	...
	button:Dock(LEFT)
	button:SetText(" ") -- display name is also the ID
...
function PANEL:Init()
	...
	self.name:SetExpensiveShadow(1.5, color_black)
...
function PANEL:SizeToContents()
	...
	self:SetTall(self.name:GetTall())
end
...
function PANEL:Init()
	...
	self.autocomplete:SetVerticalScrollbarEnabled(false)
