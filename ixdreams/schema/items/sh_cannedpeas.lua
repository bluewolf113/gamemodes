...
ITEM.model = "models/illusion/eftcontainers/peas.mdl" -- Replace with an actual coffee bean model if available
ITEM.width = 1
ITEM.height = 1
ITEM.category = "Food"
...
ITEM.functions.combine = {
  OnRun = function(item, data)
    ...
    inv:Add("canofpeas", 1, nil, x, y)

    -- 4) Play sound on *player*, not “client”
    player:EmitSound("physics/flesh/flesh_squishy_impact_hard4.wav", 40, 100)
