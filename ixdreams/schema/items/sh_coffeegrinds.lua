ITEM.name = "Bag of Coffee Beans"
ITEM.description = "A bag of raw coffee beans, ready for roasting."
ITEM.model = "models/props_junk/garbage_bag001a.mdl" -- Replace with an actual coffee bean model if available
ITEM.width = 1
ITEM.height = 2
ITEM.category = "Food"
