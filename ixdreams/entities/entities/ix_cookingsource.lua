...
if SERVER then
    ...
    function ENT:Initialize()
		self:SetDisplayName((self:GetDisplayName() ~= nil and self:GetDisplayName() ~= "" and self:GetDisplayName()) or "Stove")
		self:SetDescription((self:GetDescription() ~= nil and self:GetDescription() ~= "" and self:GetDescription()) or "An old gas stove.")
		self:SetVisibleModel((util.IsValidModel(self:GetVisibleModel()) and self:GetVisibleModel()) or "models/props_c17/furnitureStove001a.mdl")
