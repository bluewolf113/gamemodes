...
ITEM.name = "Beige Pea Coat"
ITEM.description = "With pockets on pockets, this pea coat sits snug across you.	"
ITEM.category = "Clothing"
ITEM.model = "models/tnb/halflife2/world_torso_jacket_brown.mdl"
ITEM.width = 1
ITEM.height = 1
