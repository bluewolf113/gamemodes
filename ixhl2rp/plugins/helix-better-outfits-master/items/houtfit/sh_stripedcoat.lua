...
ITEM.name = "Striped Coat"
ITEM.description = "The excessive collar and thick lining saves you from the cold, cold winter.	"
ITEM.category = "Clothing"
ITEM.model = "models/tnb/halflife2/world_torso_rainjacket.mdl"
ITEM.width = 1
ITEM.height = 1
