...
ITEM.name = "Beige Bomber Jacket"
ITEM.description = "Big, heavy, and warm. This jacket checks off all the boxes."
ITEM.category = "Clothing"
ITEM.model = "models/tnb/halflife2/world_torso_hoodedjacket.mdl"
ITEM.width = 1
ITEM.height = 1
