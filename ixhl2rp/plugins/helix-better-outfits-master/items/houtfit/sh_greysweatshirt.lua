...
ITEM.name = "Grey Sweatshirt"
ITEM.description = "Keeps a wearer warm enough for an hour or so in the cold. It's not the best for warmth, but it's got pockets - so many pockets!"
