...
ITEM.description = "If this had a hood it'd be perfect. Except it doesn't. Not the warmest, but it makes the cold bearable."
ITEM.category = "Clothing"
ITEM.model = "models/tnb/halflife2/world_torso_leatherjacket.mdl"
ITEM.width = 1
ITEM.height = 1
